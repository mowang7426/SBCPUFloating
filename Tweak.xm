...
// 🔥 Insulation 核心配置变量 (0: 原生温控, 1: 模拟低电频率, 2: 防止温控降频)
...
#pragma mark - 9. SBCPUFloatingView 悬浮窗控件
...
- (void)handlePan:(UIPanGestureRecognizer *)pan {
    ...
    if (pan.state == UIGestureRecognizerStateBegan) {
        ...
        self.center = CGPointMake(self.lastPoint.x + t.x, self.lastPoint.y + t.y);
...
#pragma mark - 13. 设置控制器与 UIMenu 菜单实现
...
#pragma mark - 14. 配置持久化与构造入口 (%ctor)
