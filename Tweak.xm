...
// 🔋 iOS 底层节电守护进程（负责系统真实 CPU 调频与节能调度）
...
#pragma mark - 5. 🔥 真实系统级 CPU 调频与温控破限引擎 🔥

// 真实向 iOS 系统内核与电量守护进程下达硬件调频指令
static void applyHardwareCpuGovernor(NSInteger mode) {
...
#pragma mark - 8. SBCPUFloatingView 悬浮窗控件实现
